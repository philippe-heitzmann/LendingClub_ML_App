...
#Load data
df = pd.read_csv('accepted_2007_to_2018Q4_500.csv', sep = ',')
...
with open('eda4.pickle','rb') as eda4File:
     eda4 = pickle.load(eda4File)

#loading groupby addr_state, grade, int data
with open('eda5.pickle','rb') as eda5File:
     eda5 = pickle.load(eda5File)

with open('x_train_lg1.pickle','rb') as x_train_lg1_file:
    x_train_lg1 = pickle.load(x_train_lg1_file)

with open('test_data2.pickle','rb') as test_data2_file:
...
def update_ml_description_text(model):
    ...
    # elif model == 'CAT':
    #     return 'CatBoost Classifier is a model that'
